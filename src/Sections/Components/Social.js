...
function Social(props) {
    return (
        <div className={`${props.position}`}>
            ...
            <a target="_blank" rel="noreferrer" href="https://www.facebook.com/ecell.aith?mibextid=ZbWKwL"><span><i className="fab fa-facebook-f"></i></span></a>
            ...
            <a target="_blank" rel="noreferrer" href="ecellaith@gmail.com"><span><i className="fab fa-medium"></i></span></a>
